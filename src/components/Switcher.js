...
const Switcher = () => {
	...
	return (
		<Fragment>
			...
			<div id="switcher" className={toggle ? "open" : "close"} style={{ display: "block" }}>
				<div className="content-switcher">
					...
					<ul>
						{colors.map((color) => (
							<li>
								<a href="#" title={color.name} className="color" key={color.id} onClick={() => setColor(color.name)}>
			...
			<div id="showSwitcher" className={`styleSecondColor ${toggle ? "close" : "open"}`} onClick={() => setToggle(true)}>
